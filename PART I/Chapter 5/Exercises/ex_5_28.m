...
tspan = [0,10];      % time vector
x0 = [1 1 1].';        % deviations from nominal trajectory @ t = t_0
xhat0 = [0 0 0].';     % initial estimate of deviations from nominal trajectory @ t = t_0
P0 = eye(3);      % confidence over the initial estimate of deviations from nominal trajectory @ t = t_0
stateNames = {'x_1', 'x_2', 'x_3'};
