...
% contrived values for parameters
r0 = 1;
w = 1;
%%
% x1 = r, x2 = rdot, x3 = theta, x4 = thetadot
F = [0 1 0 0;3*(w^2) 0 0 2*r0*w;0 0 0 1;0 (-2*w/r0) 0 0];
...
x0 = [.1 0 0 .2].';        % deviations from nominal trajectory @ t = t_0
xhat0 = [0 0 0 0].';       % initial estimate of deviations from nominal trajectory @ t = t_0
P0 = eye(4);               % confidence over the initial estimate of deviations from nominal trajectory @ t = t_0
